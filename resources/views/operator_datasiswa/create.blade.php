    ...
    <div class="card">
        <div class="card-body d-flex flex-column justify-content-center">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('siswa_nama') is-invalid @enderror" id="siswa_nama" name="siswa_nama" value="{{ old('siswa_nama') }}">
                @error('siswa_nama')
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control @error('siswa_nisn') is-invalid @enderror" id="siswa_nisn" name="siswa_nisn" value="{{ old('siswa_nisn') }}">
                @error('siswa_nisn')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                <select class="form-select @error('siswa_jenis_kelamin') is-invalid @enderror" aria-label="Default select example" name="siswa_jenis_kelamin" id="siswa_jenis_kelamin">
                    ...
                    <option value="1" {{ old('siswa_jenis_kelamin') == '1' ? 'selected' : '' }}>Laki Laki</option>
                    <option value="0" {{ old('siswa_jenis_kelamin') == '0' ? 'selected' : '' }}>Perempuan</option>
                </select>
            ...
            <div class="col-md-12">
                ...
                <textarea name="siswa_alamat" id="siswa_alamat" class="form-control @error('siswa_alamat') is-invalid @enderror" name="siswa_alamat">{{ old('siswa_alamat') }}</textarea>
                @error('siswa_alamat')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('siswa_nomor_telepon') is-invalid @enderror" id="siswa_nomor_telepon" name="siswa_nomor_telepon" value="{{ old('siswa_nomor_telepon') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('siswa_tempat_lahir') is-invalid @enderror" id="siswa_tempat_lahir" name="siswa_tempat_lahir" value="{{ old('siswa_tempat_lahir') }}">
            ...
            <div class="col-md-6">
                ...
                <div>
                <input type="date" class="form-control @error('siswa_tempat_lahir') is-invalid @enderror" id="siswa_tanggal_lahir" name="siswa_tanggal_lahir" value="{{ old('siswa_tanggal_lahir') }}">
                @error('siswa_tempat_lahir')
                    <div class="invalid-feedback">
                    {{ $message }}
                    </div>
